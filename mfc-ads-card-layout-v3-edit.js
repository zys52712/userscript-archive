...
function runWithInterval(times = 5, delay = 5000) {
...
function clearInterval2() {
  ...
  async function fetchRandom() {
    const url = 'https://myfigurecollection.net/?mode=browse&current=keywords&itemId=0&type=0&isMIB=0&status=0&sort=date&order=desc&minimumPrice=0&maximumPrice=0&currency=USD&categoryId=0&itemCondition=0&boxCondition=0&myFavorites=0&wished=0&isFeatured=0&_tb=classified&page=12'
